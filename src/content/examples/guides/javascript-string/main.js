...
let text12 = 'ვებგვერდისთვის ძირითადად გვჭირდება: HTML, CSS, JavaScript.';
console.log(text12.search('CSS')); // 42
console.log(text12.search('SCSS')); // -1
console.log(text12.search(/javascript/i)); // 47

let text13 = 'ვებგვერდისთვის ძირითადად გვჭირდება: HTML, CSS, JavaScript.';
console.log(text13.split()); // ['ვებგვერდისთვის ძირითადად გვჭირდება: HTML, CSS, JavaScript.']
console.log(text13.split('')); // ["ვ", "ე", "ბ", "გ", "ვ", "ე", ... ] ყოველი სიმბოლო გადადის რიგრიგობით მასივში
console.log(text13.split(' ')); // ['ვებგვერდისთვის', 'ძირითადად', 'გვჭირდება:', 'HTML,', 'CSS,', 'JavaScript.']
console.log(text13.split(':')); // ['ვებგვერდისთვის ძირითადად გვჭირდება', ' HTML, CSS, JavaScript.']

let text14 = 'ვებგვერდისთვის ძირითადად გვჭირდება: HTML, CSS, JavaScript.';
console.log(text14.slice(15)); // 'ძირითადად გვჭირდება: HTML, CSS, JavaScript.'
console.log(text14.slice(15, 34)); // 'ძირითადად გვჭირდება'
console.log(text14.slice(-22)); // 'HTML, CSS, JavaScript.'
console.log(text14.slice(-22, -13)); // 'HTML, CSS'

let text15 = 'ვებგვერდისთვის ძირითადად გვჭირდება: HTML, CSS, JavaScript.';
console.log(text15.substring(15)); // 'ძირითადად გვჭირდება: HTML, CSS, JavaScript.'
console.log(text15.substring(15, 34)); // 'ძირითადად გვჭირდება'
console.log(text15.substring(-22)); // 'ვებგვერდისთვის ძირითადად გვჭირდება: HTML, CSS, JavaScript.'
console.log(text15.substring(-22, -13)); // ''
...
let text16 = '      რაღაც ტექსტი      '; // დასაწყისშიც და დასასრულშიც 6 ზედმეტი space არის მოთავსებული
console.log(text16.length); // 24
console.log(text16.trim()); // 'რაღაც ტექსტი'
console.log(text16.trim().length); // 12
console.log(text16.trimStart()); // 'რაღაც ტექსტი      '
console.log(text16.trimStart().length); // 18
console.log(text16.trimEnd()); // '      რაღაც ტექსტი'
console.log(text16.trimEnd().length); // 18
