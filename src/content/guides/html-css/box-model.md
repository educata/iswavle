...
keywords: "box model, ყუთის მოდელი, განლაგება, layout"
---
...
ბოქსი არც თუ ისე განსხვავდება ხახვისგან, რადგან მასაც გააჩნია **შრეები**.
...
- **Margin box:** გარე შრე, რომელიც ფუთავს კონტენტს, პადინგსა და ბორდერს. იგი წარმოადგენს თავისუფალ სივრცეს ამ ბოქსსა და სხვა ელემენტებს შორის. მისი გასტილვა შეგვიძლია `margin` თვისებით.
...
ელემენტს ზემოთ განხილული შრეები იმ ზომებზე აქვს დაყენებული, რომელზეც მივუთითეთ.
