...
`Map` არის იტერირებადი სტრუქტურა. მასზე იტერაცია შესაძლებელია შემდეგი სინტაქსით:
...
| ზომა                     | `Map`-ში არსებული ელემენტების დასათვლელად, შეგვიძლია მარტივად გამოვიყენოთ `size` თვისება                               | ობიექტში თვისებების დასათვლელად არ გვაქვს მეთოდი. დასათვლელად შეგვიძლია გამოვიყენოთ `Object.keys` მეთოდი და შემდეგ ამავე მასივიდან წავიკითხოთ სიგრძე.                                                                                                                                                                                                                                                        |
