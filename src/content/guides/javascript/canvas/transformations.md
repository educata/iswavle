...
კანვასი. შემდეგ შევინახეთ მისი სთეითი, ამჟამად მას აქვს ნაგულისხმევი თვისებები, ამიტომაც სთეითში
შევინახეთ შავი ფერი. შემდეგ შევუცავლეთ ფერი ლურჯზე, დავხატეთ ახალი მართკუთხედი და შევინახეთ
ახალი სთეითი. ახლა ჩვენ სთეითში გვაქვს ლურჯი ფერი, ხოლო მის წინა სთეითში შავი ფერი. შემდეგ დავხატეთ
თეთრი ფერის მართკთხედი. მის შემდეგ აღვადგინეთ სთეითი, რამაც დაგვიბრუნა ლურჯი ფერი და მისი გამოყენებით
...
რადიანის მისაღებად საჭიროა შემდეგი ფორმულის გამოყენება: `radians = (Math.PI / 180) * degree`.
...
შემდეგი ტრანსფორმის მეთოდი არის `scale`. მეთოდის გამოყენებით შესაძლებელია ელემენტის ზომების
გაზრდა ან შემცირება.
