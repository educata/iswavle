...
ახალი სთეითი, უკვე ჩვენს სთეითში გვაქვს ლურჯი ფერი და მის წინა სთეითში შავი ფერი. შემდგომ დავხატეთ
...
წარმოიდგინეთ ეხლა ფერის ნაცვლად სხვა თვისებებთან ერთად რამდენ ხაზს დავზოგავდით.

## Translating

პირველი თვისება რასაც ტრანსფორმაციის მეთოდებში განვიხილავთ იქნება `translate`. მეთოდი გამოიყენება იმისათვის
...
ღბულობს ორ პარამეტრს: `x` და `y` კორდინატებს. ამ კორდინატების მიხედვით შეგვიძლია განვსაზღვროთ თუ საიდან დაიწყება
