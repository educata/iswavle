...
1. **გავასუფთავოთ კანვასი** სხვა ზედმეტი ფიგურებისგან, რომლებიც ამჟამინდელ
   კადრში არ გვჭირდება. ყველაზე მარტივი მიდგომა არის [`clearRect`](./doc/guides/javascript/canvas/drawing-figures#clearRect)
   მეთოდის გამოყენება.
...
ასეთ დროს არ არის საჭირო `setInterval`-ის გამოყენება (თუ რაიმე სპეციფიკურს არ აკეთებთ გარკვეული დროის შემდგომ) - ჩვენ შეგვიძლია მოვუსმინოთ მომხარებლის
...
შემდგომ თავში კი განვიხილავთ შედარებით [რთულ ანიმაციებს](./doc/guides/javascript/canvas/advanced-animations)
