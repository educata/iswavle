...
გაითვალისწინეთ, `fillStyle` და `strokeStyle` გამოყენების შემდეგ, იმავე კანვასში რა ფიგურასაც ან ელემენტს დაამატებთ,
...
ნაგულისხმევად თვისების მნიშვნელობა არის `1`. როდესაც ამ თვისებას მივანიჭებთ კანვას, მის შემდეგ ყოველი ფიგურა მიიღებს
...
ამ მაგალითში სამივე თვისების მნიშვნელობა გამოვიყენეთ. კოდის გაშვების შემდეგ შეამჩნევთ ვიზუალურ
