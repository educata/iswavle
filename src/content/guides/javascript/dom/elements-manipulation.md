...
მაგალითში ჯერ ვიღებთ ელემენტს, შემდეგ ღილაკებზე დაკლიკებას ვუსმენთ და დაკლიკების შედეგად
...
ფორმის ელემენტებთან მუშაობა უფრო დეტალურად განხილული იქნება [ფორმების სტატიაში](./doc/guides/javascript/dom/form).
...
ამ მაგალითში დაკლიკების შემდეგ დაილოგება ღილაკის ატრიბუტების მნიშვნელობები. შეგვეძლო ჩვეულებრივი ფუნქციის ნაცვლად
...
გვჭირდება დინამიურად მინიჭებული კლასის სახელები, მაგალითად: ჩამოსქროლვის შემდეგ რაღაც ელემენტმა მიიღოს კლასი,
...
მაგალითად, ღილაკზე დაკლიკების შემდეგ დავამატოთ კლასი:
...
ამ მაგალითში, ღილაკზე დაკლიკების შემდეგ დივი, რომელსაც `addClassContainer` მნიშვნელობის `id` აქვს, მიიღებს კლასს `animate`.
...
მაგალითად ღილაკზე დაკლიკების შემდეგ წავშალოთ კლასი:
...
ამ მაგალითში განიხილება ღილაკზე დაკლიკების შემდეგ `animate` კლასის წაშლა დივიდან.
...
მაგალითად, ღილაკზე დაკლიკების შემდეგ გავაკეთოთ toggle კლასის:
...
`createElement` მეთოდის გამოყენებით გვიწევს ჯერ ელემენტის შექმნა, შემდეგ მისი შესაბამისად მოდიფიცირება და ბოლოს
