...
გამოვიძახოთ `initGame` ფუნქცია, რომელსაც პარამეტრად გავაყოლებთ ობიექტს შემდგომი
...
გაეცნოთ და შემდგომ დაიწყოთ მისი გამოყენება.
...
მომხარებელმა სწორ ადგილას დააკლიკა თუ არა და შემდგომ ქულა რამდენით მოემატოს.
...
გამოყენება გვჭირდება იმისათვის, რომ შემდგომ `initGame`-ში თუ არ გადავცემთ დადებით
...
მას `'data-clicked'` ატრიბუტი დაემატება, რომელსაც შემდგომ გამოვიყენებთ იმის შესამოწმებლად,
