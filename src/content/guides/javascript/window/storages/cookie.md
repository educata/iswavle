...
სიახლეები. გარკვეული დროის შემდეგ კი გათიშა ბრაუზერი ან საერთოდაც დაარეფრეშა (გადატვირთა) აპლიკაცია. ამ შემთხვევაში
...
ამრიგად ავტორიზაციის შემდეგ, სერვერი ცნობს მომხარებელს და უბრუნებს შესაბამის ინფორმაცაის cookie-დან გამომდაინრე.
...
თითოეულ cookie-ს გააჩნია შემდეგი თვისებები:
