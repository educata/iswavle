...
- [`სტრინგები`](./guides/javascript/string) გადაკეთება შედარებით კომპლექსურია, თუ არის შესაძლებელია მივიღოთ რიცხვი მაშინ გადაკეთდება, როგორც რიცხვად თუმცა თუ ფიზიკურად სტრინგის მნიშვნელბოა ვერ გადაკეთდება რიცხვად მაშინ ვღებულობთ `NaN`. მხოლოდ whitespace (`" "`) გადაკეთდება როგორც `0`.
