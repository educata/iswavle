...
`new` ქივორდის გამოყენებით ხდება შემდეგი მოქმედებები:
...
Dot notation გულისხმობს ობიექტის სახელი წარმოვადგინოთ, როგორც `namespace` და შემდეგ წერტილის საშუალებით მივწდეთ მას. მაგალითად:
...
Bracket notation საკმაოდ წაააგავს მასივიდან ([`array`](./doc/guides/javascript/array) განხილული იქნება შემდეგ თავში) მნიშვნელობის წაკითხვას, ოღონდ განსხვავება გვაქვს შემდეგ ნაირი: ვიყენებთ მნიშვნელობს სახელს და არა ინდექს. ხშირად ობიექტებს მოიხსენიებენ, როგორც **ასოცირებულ მასივს**. ხშირ შემთხვევაში წერტილით მიწვდომა, გამოიყენება პრაქტიკაში თუმცა გვაქვს შემთხვევებიც, როცა საჭიროა Bracket notation გამოყენებაც. მაგალითი:
...
როგორ მოვიქცეთ თუ ახალი ობიექტის შექმნა გვსურს, რომელსაც განსხვავებული მისამართი ექნება მაგრამ იგივე მნიშვნელობები. ასეთ დროს გვჭირდება შემდეგი მიდგომების გამოყენება:
