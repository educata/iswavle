---
title: 'ცხრილები'
keywords: 'ცხრილები, table, tables, data visualization, rows, columns, სვეტები, სტრიქონები'
---
...
მაგრამ გარეგნობის მხრივ ამას ცხრილის მთავარი ატრიბუტები აკლია: [ჩარჩოები](/doc/guides/html-css/box-model#Border)!
...
<iframe data-url="guides/html-css-table-border" data-title="HTML ცხრილი ჩარჩოებით"></iframe>
...
სერჩ ენჯინებისთვისა და შ.შ.მ პირების დამხმარე მოწყობილობებისთვის ახლა მკაფიოა,
...
<iframe data-url="guides/html-css-table" data-title="HTML ცხრილი"></iframe>
