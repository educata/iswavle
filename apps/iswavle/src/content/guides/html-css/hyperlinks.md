...
- **ქვემოთ ფოლდერებში (subdirectory):** თუ გვინდა მთავარი გვერდიდან `nested` დოლდერში არსებულ ფაილზე გადასვლა.

```html
<p>ნახეთ <a href="nested/index.html">ეს გვერდი</a>.</p>
<!-- მხოლოდ ფოლდერის სახელიც საკმარისია თუ მასში `index.html`-ის გახსნა გვინდა -->
<p>ნახეთ <a href="nested">ეს გვერდი</a>.</p>
```

- **ზემოთ ფოლდერში გადასვლა:** ვთქვათ, ვართ `nested/index.html`-ზე და გვინდა ზემოთ არსებულ `contact.html`-ზე გადასვლა:

```html
<p><a href="../contact.html">დაგვიკავშირდით</a>, რათა გაიგოთ მეტი.</p>
```
