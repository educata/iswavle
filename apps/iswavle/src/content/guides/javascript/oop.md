...
ასე შევქმენით `Human` კლასი, სადაც გვაქვს ორი თვისება და ერთი მეთდი. კლასის შექმნა იწყება `class` ქივორდით, რომელსაც შემდეგ ვუწერთ სახელს.
...
წინა მაგალითში კონსტრუქტორში განსვსაზღვრეთ ორი პარამეტრი: `name` და `age`, რომლებიც შემდეგ მივანიჭეთ კლასში არსებულ თვისებებს.
...
შემდეგ შესაძლებელი ხდება ამ ობიექტების მათთვის მიწოდება (ან ჩანაცვლება) სხვადასხვა გზით.
...
ანუ აცხადებს თავის dependency-ს, რომელსაც შემდეგ ინსტანციის შექმნისას იღებს.
...
ჯერ დამოუკიდებელ `Knight` და `General` კლასებს ვქმნით, ხოლო შემდეგ
`Soldier` კლასს, რომელსაც `General`-ის ინსტანცია სჭირდება. შემდეგ ვქმნით
