...
JavaScript-ში ხშირად შევხდებით შემდეგ [პრიმიტიულ ტიპებს](./doc/guides/javascript/data-types#პრიმიტიული_მნიშვნელობები):
...
სამივე შემთხვევაში ტაიპსკრიპტმა იცის ცვლადების ტიპების შესახებ. ტიპის მინიჭება ხდება ცვლადის აღწერისას, შემდეგი სინტაქსით:
...
`[1, 2, 3]` მსგავსი მასივის აღსაწერად შეგვიძლია ჩავწეროთ შემდეგი სინტაქსი: `number[]` ან `Array<number>`.
ორივე ფორმა მიღებულია ტიპიზირებისთვის. მეორე ვარიანტს (ჯენერიკებს - `T<U>`) განვიხილავთ შემდეგ სტატიაში.
...
მისი აღწერა ტაიპსკრიპტში ხდება შემდეგნაირად:
...
ამ მაგალითში ჩანს, რომ ცვლადი ინიციალიზების დროს იყო ტექსტური ტიპის, შემდეგ გახდა ბულიანი და ბოლოს რიცხვი.
...
console.log(something.toFixed()); // კოდის გაშვების შემდეგ გავიგებთ, რომ 'something'-ს არ გააჩნდა toFixed მეთოდი.
```
...
union ტიპის შესაქმნელად საჭიროა შემდეგი სინტაქსი:
...
ამ მაგალითში განვსაზღვრეთ `Direction`-ის ენამი, რომელსაც ექნება შემდეგი შესაძლო კონსტანტური მნიშვნელობები:
...
მნიშვნელობები შეიცვლებოდა შემდეგნაირად:
...
ასე ვღებულობთ `Direction`-ის ენამს, სადაც პირველი მნიშვნელობის მიხედვით იცვლება დანარჩენი (პირველი ინდექსის შემდეგ, n + 1).
...
რეალურად ინტერფეისების დაყოფა უფრო მეტ ნაწილადაც შეგვიძლია, რომ კოდში შემდეგ თავისუფლად გამოვიყენოთ ისინი ცალკ-ცალკე.
...
ამრიგად მივიღეთ დინამიური ობიექტი. მისი გამოყენება შემდეგია:
