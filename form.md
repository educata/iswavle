...
`select` არის ფორმის ელემენტი, რომელიც მომხმარებელს საშუალებას აძლევს აარჩიოს წინასწარ განსაზღვრული მნიშვნელობებიდან რომელიმე ივარიანტი.
...
```html preview
<form action="https://api.everrest.educata.dev/echo/html" method="post">
  <label for="food">საყვარელი საჭმელი:</label> <br />
  <select id="food" name="food">
    <option value="ხაჭაპური">ხაჭაპური</option>
    <option value="ლობიანი">ლობიანი</option>
    <option value="ხინკალი">ხინკალი</option>
    <option value="მწვადი">მწვადი</option>
    <option value="ფხალი">ფხალი</option>
  </select>
  <br />
  <button>გაგზავნა</button>
</form>
